<div wire:ignore.self class="modal fade" id="sumarModal" tabindex="-1" role="dialog" data-bs-backdrop="static"
    data-bs-keyboard="false">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background: #0654a1">
                <h5 class="modal-title text-white">Aumentar | Producto</h5>
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" wire:click.prevent="sumarStock()"
